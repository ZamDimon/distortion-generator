...
def train_embedding_model(
    ...
    if model_save_path is None:
        model_save_path = Path('./models') / f"{hyperparams.meta.version}_{hyperparams.meta.subversion}"
    if history_path is None:
        history_path = Path(f'./images/embedding/history_{hyperparams.meta.version}_{hyperparams.meta.subversion}.png')
